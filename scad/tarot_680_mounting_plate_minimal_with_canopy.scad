...
//        translate(jetson_nano_translation) rotate(jetson_nano_rotation) jetson_nano_standoffs();
    }
    union()
    {
...
//        translate(jetson_nano_translation) rotate(jetson_nano_rotation) jetson_nano_holes();
    }
}
// ********************** /main **********************
